...
namespace BankManagerApp.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public string Paragraph { get; set; } =
            $"Access detailed statistics by country for all the Scandinavian accounts, " +
            $"allowing you to track our bank's performance and identify trends in Scandinavian banking.";
